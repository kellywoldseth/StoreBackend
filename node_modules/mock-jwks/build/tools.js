...
var createJWKS = function (_a) {
    ...
    var certPem = (0, exports.createCertificate)({
...
var signJwt = function (privateKey, jwtPayload, kid) {
    var bufferedJwt = Buffer.from(JSON.stringify(jwtPayload));
    return (0, jsonwebtoken_1.sign)(bufferedJwt, forge.pki.privateKeyToPem(privateKey), {
        algorithm: 'RS256',
        header: { kid: kid }
    });
};
